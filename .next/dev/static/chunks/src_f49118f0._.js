...
"[project]/src/lib/gameService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function uploadPhoto(file, slug, stage) {
    ...
    const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from('photos').upload(path, file, {
        upsert: true
    });
    if (error) {
    ...
    const { data } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from('photos').getPublicUrl(path);
...
async function saveGame(state) {
    try {
        ...
        // 1. Insert game row
        const { data: game, error: gameError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('games').insert({
            slug,
        ...
        const { error: wishError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('wishes').insert(wishRows);
        if (wishError) {
...
async function loadGame(slug) {
    const { data: game, error: gameError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('games').select('*').eq('slug', slug).single();
    if (gameError || !game) return null;
    const { data: wishes, error: wishError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('wishes').select('*').eq('game_id', game.id).order('stage', {
        ascending: true
    });
...
"[project]/src/components/gameData.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/components/audio.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$gameData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/gameData.ts [app-client] (ecmascript)");
;
let audioCtx = null;
function getAC() {
...
function sndBday() {
    try {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$gameData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BDAY_NOTES"].forEach(([f, d])=>{
...
"[project]/src/components/drawUtils.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$gameData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/gameData.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$audio$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/audio.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$drawUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/drawUtils.ts [app-client] (ecmascript)");
;
...
function Game({ customData }) {
    _s();
    const activeWishes = customData?.wishes ?? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$gameData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WISHES"];
    ...
    const [wishIdx, setWishIdx] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [hStage, setHStage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1);
    const [hStars, setHStars] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [hScore, setHScore] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [hLives, setHLives] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(3);
    const [progPct, setProgPct] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [progCnt, setProgCnt] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('0/10');
    const [progLab, setProgLab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('Stage 1 — Collect 10 ⭐');
    const [transMsg, setTransMsg] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [transOpen, setTransOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [goScore, setGoScore] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [dotParticles] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "Game.useState": ()=>Array.from({
                length: 70
            }, {
                "Game.useState": (_, i)=>({
                        id: i,
    ...
    const lLRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false), lRRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    ...
    const screenRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])('intro');
    ...
    const doTransition = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Game.useCallback[doTransition]": (msg, cb)=>{
            setTransMsg(msg);
            setTransOpen(true);
            setTimeout({
                "Game.useCallback[doTransition]": ()=>{
                    cb();
                    setTransOpen(false);
                }
            }["Game.useCallback[doTransition]"], 380);
        }
    }["Game.useCallback[doTransition]"], []);
    const initStage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Game.useCallback[initStage]": (n)=>{
            const g = G.current;
            g.stage = n;
            g.starsN = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$gameData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STARS_NEEDED"][n - 1];
            g.starsC = 0;
            g.speed = 3.8 + n * .42;
            g.stars = [];
            g.obstacles = [];
            ...
            g.obsTimer = 0;
            g.roadScroll = 0;
            g.stageColor = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$gameData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STAGE_COLORS"][n - 1];
            g.invincible = 0;
            g.shakeT = 0;
            g.running = true;
            setHStage(n);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Game.useEffect": ()=>{
            ...
            function loop(ts) {
                ...
                if (g.running) {
                    ...
                    if (!lLRef.current && keysRef.current['ArrowLeft']) {
                        ...
                        if (g.car.lane > 0) {
                            g.car.lane--;
                            g.car.targetX = g.laneXs[g.car.lane];
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$audio$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sndRev"])();
                        }
                    }
                    ...
                    for(let i = g.stars.length - 1; i >= 0; i--){
                        ...
                        if (Math.abs(g.car.x - s.x) < g.car.w * .75 + s.w - 10 && Math.abs(g.car.y - s.y) < g.car.h * .5 + s.w - 10) {
                            ...
                            g.starsC++;
                            g.totalScore++;
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$audio$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sndCollect"])();
                            ...
                            if (g.starsC >= g.starsN) {
                                g.running = false;
                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$audio$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sndWin"])();
                                spawnConfetti(60);
                                setTimeout({
                                    "Game.useEffect.loop": ()=>{
                    ...
                    for(let i = g.obstacles.length - 1; i >= 0; i--){
                        ...
                        if (g.invincible <= 0 && Math.abs(g.car.x - o.x) < g.car.w * .75 + o.r - 12 && Math.abs(g.car.y - o.y) < g.car.h * .5 + o.r - 12) {
                            ...
                            g.invincible = 90;
                            g.shakeT = 25;
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$audio$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sndCrash"])();
                            spawnConfetti(16);
                            setHLives(g.lives);
                            if (g.lives <= 0) {
                                g.running = false;
                                ...
                                setTimeout({
                                    "Game.useEffect.loop": ()=>doTransition('OH NO! 💥', {
                                            "Game.useEffect.loop": ()=>setScreen('gameover')
                                        }["Game.useEffect.loop"])
                                }["Game.useEffect.loop"], 500);
                                return;
                            }
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$drawUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["drawSpaceBg"])(ctx, W, H, g.bgStars, g.stageColor, g.bgTimer);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$drawUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["drawRoad"])(ctx, W, H, g.roadScroll, g.stageColor, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$gameData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STAGE_NAMES"][g.stage - 1]);
                // puffs
                g.puffs = g.puffs.filter({
                    "Game.useEffect.loop": (p)=>{
                        p.y -= 1.4;
                        p.r += .45;
                        p.op -= .045;
                ...
                g.stars.forEach({
                    "Game.useEffect.loop": (s)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$drawUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["drawStar3D"])(ctx, s.x, s.y, s.w * .5, s.spin)
                }["Game.useEffect.loop"]);
                g.obstacles.forEach({
                    "Game.useEffect.loop": (o)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$drawUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["drawObstacle"])(ctx, o.x, o.y, o.r, o.type)
                }["Game.useEffect.loop"]);
                if (!(g.invincible > 0 && ~~(g.invincible / 5) % 2 === 1)) {
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$drawUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["drawToycar"])(ctx, g.car.x, g.car.y, g.car.w, g.car.h, g.stageColor);
                }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Game.useEffect": ()=>{
            setTimeout({
                "Game.useEffect": ()=>spawnConfetti(30)
            }["Game.useEffect"], 600);
        }
    }["Game.useEffect"], []);
    ...
    const continueFromWish = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Game.useCallback[continueFromWish]": ()=>{
            ...
            if (stage >= totalStages) {
                doTransition('🏆 CHAMPION!', {
                    "Game.useCallback[continueFromWish]": ()=>{
                        setScreen('winner');
                        spawnConfetti(140);
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$audio$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sndBday"])();
                    }
                }["Game.useCallback[continueFromWish]"]);
            } else {
                const ns = stage + 1;
    ...
    const playAgain = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Game.useCallback[playAgain]": ()=>{
            G.current.lives = 3;
            G.current.totalScore = 0;
            doTransition('NEW RACE! 🏁', {
                "Game.useCallback[playAgain]": ()=>setScreen('intro')
            }["Game.useCallback[playAgain]"]);
        }
    }["Game.useCallback[playAgain]"], [
        doTransition
    ...
    const isTouch = ("TURBOPACK compile-time value", "object") !== 'undefined' && 'ontouchstart' in window;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            screen === 'intro' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                style: {
                    position: 'fixed',
                    inset: 0,
                ...
                children: [
                    dotParticles.map((d)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            style: {
                                position: 'absolute',
                                borderRadius: '50%',
                                width: d.size,
                                    ...
                                    length: totalStages
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$gameData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STAGE_ICONS"][i] ?? '⭐'
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/Game.tsx",
                                                lineNumber: 309,
                                                columnNumber: 17
            ...
            screen === 'wish' && wish && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                style: {
                    position: 'fixed',
                    inset: 0,
                    zIndex: 300,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: wish.photo ? /* ── REPLACE BELOW with <img src={`/photo${wish.photo}.jpg`} ... /> once you add real photos to /public ── */ /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                    src: wish.photo,
                                                    style: {
                                                        width: '100%',
                                                        height: '100%',
            ...
            screen === 'gameover' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                style: {
                    position: 'fixed',
                    inset: 0,
            ...
            screen === 'winner' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                style: {
                    position: 'fixed',
                    inset: 0,
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: activeWishes.map((w, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                style: {
...
_s(Game, "coYxlDOITFfVKEXxITySuDk2T0I=");
_c = Game;
var _c;
...
"[project]/src/app/play/[slug]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/gameService.ts [app-client] (ecmascript)");
...
function PlayPage({ params }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PlayPage.useEffect": ()=>{
            async function fetchGame() {
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gameService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadGame"])(slug);
                if (!result) {
                    setNotFound(true);
                    setLoading(false);
                    return;
                ...
                const mappedWishes = wishes.map({
                    "PlayPage.useEffect.fetchGame.mappedWishes": (w, i)=>({
                            from: w.from_name,
                            av: w.avatar,
                            color: [
                                '#c084fc',
                ...
                }["PlayPage.useEffect.fetchGame.mappedWishes"]);
                setGameData({
    ...
    if (notFound) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        style: {
            minHeight: '100vh',
            background: '#080010',
            display: 'flex',
...
_s(PlayPage, "fZ5KnQ7AWk0xVY3qH9d+3NM/URI=");
_c = PlayPage;
var _c;
...
//# sourceMappingURL=src_f49118f0._.js.map